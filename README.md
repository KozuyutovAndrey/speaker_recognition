...
**Команда:** AI Amigos | **Результат:** Public P@10 = 0.7439 (7 место, 300 команд)
...
> Презентация - [Presentation-AI-Amigos.pdf](Presentation-AI-Amigos.pdf).
...
| Этап | Время |
|---|---|
| CAM++ TTA×10, 134k файлов | ~16 мин |
| ERes2Net TTA×10, 134k файлов | ~37 мин |
| K-reciprocal re-ranking | ~10 мин |
| **Итого** | **~63 мин** |
